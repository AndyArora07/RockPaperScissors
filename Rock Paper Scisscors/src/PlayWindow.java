...
class BackgroundPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        // Calling the superclass method for standard painting behavior.
...
public class PlayWindow extends JFrame {
    ...
    private void updateUI(String userChoice, String computerChoice, String result) {
        ...
        // Updating the result label with an HTML formatted string showing the choices and result.
    ...
    private void playSound(String soundFileName) {
        try {
            // Locating the sound file within the Resources directory.
